...
/**
 * Adopted from Yii2 ArrayHelper.
 */
class ArrayHelper
{
    public static function sanitizeInteger(array &$array, array $fields = []): void
    {
        foreach ($fields as $field) {
            if (static::keyExists($field, $array)) {
     ...
     * ```
     */
    public static function getValue(array|object $array, string|\Closure|array $key, mixed $default = null): mixed
    {
     ...
     * ```
     */
    public static function map(array $array, string|\Closure $from, string|\Closure $to, string|\Closure $group = null): array
    {
        $result = [];
        foreach ($array as $element) {
     ...
     */
    public static function multisort(array &$array, string|\Closure|array $key, array|int $direction = SORT_ASC, array|int $sortFlag = SORT_REGULAR): void
    {
